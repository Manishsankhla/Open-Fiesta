...
This directory preserves historical planning, gap analysis, and verbose implementation logs for the Crysta theme system. These files are retained for traceability and deeper context but are no longer the primary reference.
